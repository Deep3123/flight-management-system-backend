...
//	private static final BaseColor PRIMARY_COLOR = new BaseColor(0, 82, 156); // Deep blue
//	private static final BaseColor ACCENT_COLOR = new BaseColor(255, 102, 0); // Orange
//	private static final BaseColor LIGHT_GRAY = new BaseColor(245, 245, 245); // Light gray background
//	private static final BaseColor BORDER_COLOR = new BaseColor(200, 200, 200); // Border gray
//
//	public static byte[] generateTicketPDF(TicketProxy ticketProxy) throws Exception {
//		Document document = new Document(PageSize.A4, 50, 50, 50, 50);
//		ByteArrayOutputStream out = new ByteArrayOutputStream();
...
//			Font headerFont = FontFactory.getFont(FontFactory.HELVETICA_BOLD, 12, PRIMARY_COLOR);
...
//			Font accentFont = FontFactory.getFont(FontFactory.HELVETICA_BOLD, 14, ACCENT_COLOR);
//
//			PdfContentByte cb = writer.getDirectContent();
//
//			// Generate one ticket per passenger - each on its own page
//			for (PassengerProxy passenger : ticketProxy.getPassengers()) {
...
//
//				// Logo cell
//				PdfPCell logoCell = new PdfPCell(new Paragraph("JETWAYZ", titleFont));
//				logoCell.setBorder(Rectangle.NO_BORDER);
...
//
//				Paragraph boardingPass = new Paragraph("BOARDING PASS", headerFont);
//				boardingPass.setAlignment(Element.ALIGN_RIGHT);
//				titleCell.addElement(boardingPass);
//
//				headerTable.addCell(titleCell);
//
...
//
//				// Flight info row - FROM/TO with arrow
//				PdfPTable routeTable = new PdfPTable(3);
//				routeTable.setWidthPercentage(100);
//				routeTable.setWidths(new float[] { 2, 1, 2 });
//				routeTable.setSpacingBefore(10);
...
//
//				Paragraph fromLabel = new Paragraph("FROM", smallFont);
//				fromLabel.setAlignment(Element.ALIGN_CENTER);
//				Paragraph fromAirport = new Paragraph(ticketProxy.getFlight().getDepartureAirport(), accentFont);
//				fromAirport.setAlignment(Element.ALIGN_CENTER);
//
//				fromCell.addElement(fromLabel);
//				fromCell.addElement(fromAirport);
...
//						FontFactory.getFont(FontFactory.HELVETICA_BOLD, 24, PRIMARY_COLOR));
...
//
//				Paragraph toLabel = new Paragraph("TO", smallFont);
//				toLabel.setAlignment(Element.ALIGN_CENTER);
//				Paragraph toAirport = new Paragraph(ticketProxy.getFlight().getArrivalAirport(), accentFont);
//				toAirport.setAlignment(Element.ALIGN_CENTER);
//
//				toCell.addElement(toLabel);
//				toCell.addElement(toAirport);
//				routeTable.addCell(toCell);
//
//				mainCell.addElement(routeTable);
//
//				// Flight details table (2 columns)
...
//				flightCell.setPadding(5);
//
//				Paragraph flightLabel = new Paragraph("FLIGHT", smallFont);
//				Paragraph flightValue = new Paragraph(ticketProxy.getFlight().getFlightNumber(), boldFont);
//
//				flightCell.addElement(flightLabel);
//				flightCell.addElement(flightValue);
//				flightDetailsTable.addCell(flightCell);
//
//				// DATE information
...
//				try {
//					SimpleDateFormat outputFormat = new SimpleDateFormat("dd MMM yyyy");
//					formattedDate = outputFormat.format(departureDate);
//				} catch (Exception e) {
//					formattedDate = departureDate.toString();
//				}
//
//				Paragraph dateValue = new Paragraph(formattedDate, boldFont);
//
//				dateCell.addElement(dateLabel);
//				dateCell.addElement(dateValue);
//				flightDetailsTable.addCell(dateCell);
//
//				mainCell.addElement(flightDetailsTable);
//
//				// Time details table (2 columns)
//				PdfPTable timeTable = new PdfPTable(2);
//				timeTable.setWidthPercentage(100);
//
//				// DEPARTURE time
...
//				departureCell.setPadding(5);
//				departureCell.setBackgroundColor(LIGHT_GRAY);
//
//				Paragraph departureLabel = new Paragraph("DEPARTURE", smallFont);
//				Paragraph departureValue = new Paragraph(ticketProxy.getFlight().getDepartureTime(),
//						FontFactory.getFont(FontFactory.HELVETICA_BOLD, 12, PRIMARY_COLOR));
//
//				departureCell.addElement(departureLabel);
//				departureCell.addElement(departureValue);
//				timeTable.addCell(departureCell);
//
//				// ARRIVAL time
//				PdfPCell arrivalCell = new PdfPCell();
//				arrivalCell.setBorder(Rectangle.NO_BORDER);
//				arrivalCell.setPadding(5);
//				arrivalCell.setBackgroundColor(LIGHT_GRAY);
//
//				Paragraph arrivalLabel = new Paragraph("ARRIVAL", smallFont);
//				Paragraph arrivalValue = new Paragraph(ticketProxy.getFlight().getArrivalTime(),
//						FontFactory.getFont(FontFactory.HELVETICA_BOLD, 12, PRIMARY_COLOR));
//
//				arrivalCell.addElement(arrivalLabel);
//				arrivalCell.addElement(arrivalValue);
//				timeTable.addCell(arrivalCell);
//
//				mainCell.addElement(timeTable);
//
//				// Add space
//				Paragraph spacer = new Paragraph(" ");
//				spacer.setSpacingAfter(10);
//				mainCell.addElement(spacer);
//
//				// Passenger details table (3 columns)
//				PdfPTable passengerTable = new PdfPTable(3);
//				passengerTable.setWidthPercentage(100);
//
//				// PASSENGER name
...
//
//				Paragraph passengerLabel = new Paragraph("PASSENGER", smallFont);
//				Paragraph passengerValue = new Paragraph(passenger.getFirstName() + " " + passenger.getLastName(),
//						boldFont);
//
//				passengerCell.addElement(passengerLabel);
//				passengerCell.addElement(passengerValue);
//				passengerTable.addCell(passengerCell);
//
//				// SEAT (randomly generated)
//				PdfPCell seatCell = new PdfPCell();
//				seatCell.setBorder(Rectangle.NO_BORDER);
//				seatCell.setPadding(5);
//
//				Paragraph seatLabel = new Paragraph("SEAT", smallFont);
//				String seat = generateRandomSeat();
//				Paragraph seatValue = new Paragraph(seat,
//						FontFactory.getFont(FontFactory.HELVETICA_BOLD, 12, ACCENT_COLOR));
//
//				seatCell.addElement(seatLabel);
//				seatCell.addElement(seatValue);
//				passengerTable.addCell(seatCell);
//
...
//
//				Paragraph classLabel = new Paragraph("CLASS", smallFont);
//				String travelClass = assignRandomClass();
//				Paragraph classValue = new Paragraph(travelClass, boldFont);
//
//				classCell.addElement(classLabel);
//				classCell.addElement(classValue);
//				passengerTable.addCell(classCell);
//
//				mainCell.addElement(passengerTable);
//
//				// Add barcode
//				Paragraph barcodeTitle = new Paragraph("BOOKING REFERENCE", smallFont);
//				barcodeTitle.setAlignment(Element.ALIGN_CENTER);
//				barcodeTitle.setSpacingBefore(10);
//				mainCell.addElement(barcodeTitle);
//
...
//				codeTable.setWidthPercentage(80);
...
//
//				Barcode128 barcode = new Barcode128();
//				barcode.setCode(bookingRef);
//				barcode.setCodeType(Barcode128.CODE128);
//				Image barcodeImage = barcode.createImageWithBarcode(cb, null, null);
//				barcodeImage.scaleToFit(150, 40);
//				barcodeImage.setAlignment(Element.ALIGN_CENTER);
//
//				barcodeCell.addElement(barcodeImage);
//				barcodeCell.addElement(
//						new Paragraph(bookingRef, FontFactory.getFont(FontFactory.HELVETICA_BOLD, 10, PRIMARY_COLOR)));
...
//				String qrContent = "JW:" + ticketProxy.getFlight().getFlightNumber() + ":" + passenger.getLastName()
//						+ ":" + bookingRef;
//
...
//				Paragraph lineBreakParagraph = new Paragraph();
//				lineBreakParagraph.add(lineBreak);
//				lineBreakParagraph.setSpacingBefore(10);
//				lineBreakParagraph.setSpacingAfter(10);
//				mainCell.addElement(lineBreakParagraph);
//
//				// Terms text
//				Paragraph terms = new Paragraph(
//						"This boarding pass must be presented with a valid ID at security and boarding. "
//								+ "Please arrive at the airport 2 hours before departure. "
//								+ "Gate closes 20 minutes before departure time.",
//						smallFont);
//				terms.setAlignment(Element.ALIGN_CENTER);
//				mainCell.addElement(terms);
//
//				// Add the completed ticket to the document
//				mainTable.addCell(mainCell);
//				document.add(mainTable);
//
//				// Add page break between passengers
//				if (ticketProxy.getPassengers().indexOf(passenger) < ticketProxy.getPassengers().size() - 1) {
//					document.newPage();
//				}
//			}
...
//	private static String generateRandomSeat() {
//		char[] rows = { 'A', 'B', 'C', 'D', 'E', 'F' };
//		int row = (int) (Math.random() * 35) + 1;
//		char seat = rows[(int) (Math.random() * rows.length)];
//		return row + String.valueOf(seat);
//	}
//
//	// Assign a random class for visualization purposes
...
//		StringBuilder sb = new StringBuilder();
//		// Include both letters and numbers for a booking reference
//		String chars = "ABCDEFGHJKLMNPQRSTUVWXYZ23456789"; // Omitting confusing characters like I, O, 0, 1
//
//		for (int i = 0; i < 6; i++) {
